...
public:
    ...
    static QString heading(const QString &text, int lvl, QString &raw, const bool scrollTo = false);
    static QString hr();
    ...
    static QString wikilink(QString &href, const QString &title, const QString &text);
