...
Kirigami.PromptDialog {
    ...
    subtitle: i18nc("@subtitle:dialog, %1 can be 'category' (a note category), 'group' (a note group) or 'note' (a note)", 
        "Are you sure you want to delete this %1 ?", useCase ? useCaseTrad[useCase.toLowerCase()] : "")
